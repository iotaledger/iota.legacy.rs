...
#[inline]
pub fn tx_set_attachment_timestamp(tx: &mut [Trit], timestamp: u64) {
    num::int2trits(
        timestamp as i64,
...
#[inline]
pub fn tx_set_attachment_timestamp_lower(tx: &mut [Trit], timestamp: u64) {
    num::int2trits(
        timestamp as i64,
...
#[inline]
pub fn tx_set_attachment_timestamp_upper(tx: &mut [Trit], timestamp: u64) {
    num::int2trits(
        timestamp as i64,
